 ...
 *         description: Internal server error
 */
router.get('/user/:userId', staffController.getStaffByUserId.bind(staffController));
 ...
 *         description: Internal server error
 */
router.post('/', authMiddleware, adminMiddleware, staffController.createStaff.bind(staffController));
 ...
 *         description: Internal server error
 */
router.put('/:id', authMiddleware, adminMiddleware, staffController.updateStaff.bind(staffController));
 ...
 *         description: Internal server error
 */
router.delete('/:id', authMiddleware, adminMiddleware, staffController.deleteStaff.bind(staffController));
 ...
 *         description: Internal server error
 */
router.get('/count', authMiddleware, adminMiddleware, staffController.getStaffCount.bind(staffController));
